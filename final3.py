...
class PocketLoveApp:
    ...
    def analyser(self):
        ...
        try:
            ...
            if self.data_a["Caractère"].get() != self.data_b["Caractère"].get(): pool = CITATIONS_DB["opposés"]
            ...
            self.data_b["canvas"].itemconfig(self.data_b["b_txt"], text="Super !")
        except: messagebox.showerror("Erreur", "Vérifiez vos données.")
